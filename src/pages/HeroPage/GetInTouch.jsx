...
const GetInTouch = ({onContactClick}) => {
  return (
    <button
    ...
    >
      {/* Top */}
      <span className="
        absolute left-[-100%] top-0 h-[2px] w-full
      ...
      {/* Right */}
      <span className="
        absolute right-0 top-[-100%] h-full w-[2px]
        bg-gradient-to-b from-transparent to-cyan-400
        group-hover:animate-[getTouchRight_1s_linear_infinite]
      " />

      {/* Bottom */}
      <span className="
        absolute bottom-0 right-[-100%] h-[2px] w-full
      ...
      {/* Left */}
      <span className="
        absolute bottom-[-100%] left-0 h-full w-[2px]
        bg-gradient-to-t from-transparent to-cyan-400
